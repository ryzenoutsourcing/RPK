...
WIDGET_HTML = """
    ...
    <style>
        ...
        .booking-card { background: white; border-radius: 15px; border: 1px solid #eee; margin-top: 10px; overflow: hidden; border-left: 5px solid #2c7da0; }
        .bc-head { background: #f8fafc; padding: 10px 15px; font-weight: 700; font-size: 0.75rem; border-bottom: 1px solid #eee; }
        .bc-body { padding: 15px; font-size: 0.85rem; }
        .bc-foot { padding: 10px; background: #f8fafc; text-align: center; font-weight: 700; color: #2c7da0; }
    </style>
