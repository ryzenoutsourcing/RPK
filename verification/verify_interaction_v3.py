...
async def verify():
    async with async_playwright() as p:
        ...
        await page.screenshot(path="verification/chat_opened_v3.png")
        ...
        await page.wait_for_selector(".booking-card", state="visible", timeout=10000)
        await asyncio.sleep(2) # Wait for cards to settle
        await page.screenshot(path="verification/chat_interaction_card.png")
